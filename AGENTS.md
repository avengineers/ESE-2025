...
│   └── german_testing_magazin/
│       ├── index.md           # German Testing Magazin 1/2026 article
│       ├── index.pdf          # PDF of the article
│       ├── style.css          # Style sheet of the PDF
│       └── test_plan.md       # Test plan for the PDF toolchain
├── images/                    # Presentation images and diagrams
├── css/                       # Custom styling
├── scripts/                   # Dev container setup and PDF generation
...
## German Testing Magazin Article

The `docs/german_testing_magazin/index.md` file contains the article for the German Testing Magazin 1/2026, on test automation. It is written in German and uses the material of the ESE Kongress 2025 talk. The `index.pdf` file next to it is the PDF of the article.

To make the PDF, run `bash scripts/generate-pdf.sh` in the dev container. The script uses Pandoc, the Mermaid CLI (`mmdc`) and WeasyPrint. `scripts/postCreate.sh` installs these tools. The style of the PDF is in `docs/german_testing_magazin/style.css`. To test the toolchain on a new machine, follow `docs/german_testing_magazin/test_plan.md`.
